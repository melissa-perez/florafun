...
(1, 'Melody Smith', 'msmith@msn.com', NULL, '6601 SW WINDING WAY'),
(2, 'Kai Pope', 'popes@bing.com', '202-555-0184', '4700 SW HOLLYHOCK CIR'),
(3, 'Kim Grant', 'kgrant@yahoo.com', NULL, '1645 SW COUNTRY CLUB PL');
...
INSERT INTO `Discounts` (`discount_id`, `code`, `percent`) VALUES
(1, 'OFF10', 10),
(2, 'OFF20', 20),
(3, 'OFF30', 30),
(4, 'NONE', 0);
...
INSERT INTO `Items` (`item_id`, `flower_name`, `scientific_name`, `is_indoor`, `stock_quantity`, `price`, `supplier_id`, `color_id`) VALUES
(1, 'rose', 'rosa', 1, 300, '12.99', 1, 1),
(2, 'daisy', 'bellis perennis', 0, 500, '9.99', 1, 7),
...
INSERT INTO `Orders` (`order_id`, `order_date`, `product_quantity`, `total_sale_price`, `customer_id`, `payment_method_id`, `discount_id`) VALUES
...
INSERT INTO `Order_Items` (`order_items_id`, `quantity`, `order_id`, `item_id`) VALUES
(1, 20, 1, 1),
(2, 10, 2, 1),
(3, 10, 2, 2);
...
INSERT INTO `Payment_Methods` (`payment_method_id`, `type`) VALUES
(1, 'debit'),
(2, 'credit'),
(3, 'check');
...
INSERT INTO `Suppliers` (`supplier_id`, `name`, `address`, `email`, `is_local`) VALUES
(1, 'Flower Inc.', '680 SW WASHINGTON AVE', 'flowersinc@yahoo.com', 1),
(2, 'Sweet Honey', '675 SW SAGEBRUSH DR', 'sh@corp.com', 1),
(3, 'Bridal Flowers', '9201 CROESUS AVE', 'bridalflowers1@google.com', 0);
...
ALTER TABLE `Orders`
  ...
  ADD KEY `payment_method_id` (`payment_method_id`,`discount_id`),
...
ALTER TABLE `Items`
  ...
  ADD CONSTRAINT `Items_ibfk_2` FOREIGN KEY (`color_id`) REFERENCES `Colors` (`color_id`);
